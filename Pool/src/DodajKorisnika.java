			...
			public void mouseClicked(MouseEvent e) {
				...
				if (getGodine() <= 0) {
					JOptionPane.showMessageDialog(null,
							"Godine moraju biti unesene i ne mogu biti negativna vrijednost");
					greska = 1;
				} else {
					greska = 0;
				}
					...
					try {
						...
						int gotovo = stmt.executeUpdate(
								"INSERT INTO users (username, password, first_name, last_name, age, gender, user_role) VALUES ('"
										+ bazaUsername + "', '" + bazaPassword + "','" + bazaIme + "' , '" + bazaPrezime
										+ "','" + bazaGodine + "', '" + bazaSpol + "', '" + bazaRole + "') ");
						...
						if (gotovo > 0) {
							...
							JOptionPane.showMessageDialog(null,
									"Došlo je do greške izmedju aplikacije i dodavanja korisnika u bazu");
						}
